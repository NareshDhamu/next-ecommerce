...
const CustomizeProducts = () => {
  return (
    <div className="flex flex-col gap-6">
      ...
      <h4 className="font-medium">Choose a Color</h4>
      <ul className="flex items-center gap-3">
        <li className="ring-1 ring-narsa text-narsa rounded-md py-1 px-4 text-sm cursor-pointer">Small</li>
        <li className="ring-1 ring-narsa bg-narsa text-white rounded-md py-1 px-4 text-sm cursor-pointer">Medium</li>
