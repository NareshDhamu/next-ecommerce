...
const slides = [
    {
      ...
      description: "Discover the serene beauty of the majestic mountains and find your inner peace.",
      image:
    ...
    },
    {
      id: 2,
      title: "Sunset Bliss",
      description: "Experience the tranquil beauty of a sunset over the rolling hills.",
      image:
    ...
    },
    {
      ...
      description: "Take a walk through the lush forest and breathe in the fresh air of nature.",
    ...
    },
    {
      ...
      image: "https://images.pexels.com/photos/3794178/pexels-photo-3794178.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      url: "/",
      bg: "bg-gradient-to-r from-yellow-50 to-pink-50",
    },
  ];
